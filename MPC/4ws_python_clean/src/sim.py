...
class SimEngine:
    ...
    def __init__(self, params: VehicleParams, dt: float = 0.02):
        ...
        self.U_max = float(params.U)           
        self.dU_max = 1.5                      
        self.ay_limit_coeff = 0.85             
